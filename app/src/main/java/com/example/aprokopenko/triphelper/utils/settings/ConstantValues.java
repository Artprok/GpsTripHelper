...
public class ConstantValues {
    ...
    public static final boolean          DEBUG_MODE                    = false; //change for release to false
    public static final int              START_VALUE                   = 0;
    public static final int              AVG_SPEED_UPDATE_FREQUENCY    = 35;    //change for release to 35 or more to 60
