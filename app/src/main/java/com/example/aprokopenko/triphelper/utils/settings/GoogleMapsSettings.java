...
public class GoogleMapsSettings {
    public static final int polylineColorOutOfCity               = Color.YELLOW;
    public static final int polylineColorCity                    = Color.GREEN;
    public static final int polylineColorOutOfMaxSpeedAllowedINT = Color.RED;
